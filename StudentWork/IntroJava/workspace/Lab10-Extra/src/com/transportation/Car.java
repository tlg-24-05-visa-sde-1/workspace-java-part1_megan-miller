...
public class Car extends Vehicle {
    ...
    /*
     * If the location is West Seattle, then throw  a DestinationUnreachableException
     */
    public void moveTo(String location) throws DestinationUnreachableException
    {
        if( location.equals("West Seattle"))
        {
            throw new DestinationUnreachableException("Unable to navigate to " + location + "." +
                    " The West Seattle bridge is closed for repairs.");
        }
        else
        {
